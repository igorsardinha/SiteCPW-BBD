...
<script type="text/javascript" src="js/stl.js"></script>
  ...
  <tr id="partecima">
    <td width="80" align="center" valign="middle" bgcolor="#FF8F00"><strong>Nome</strong></td>
    <td width="150" align="center" valign="middle" bgcolor="#FF8F00"><strong>Sobrenome</strong></td>
    <td width="200" align="center" valign="middle" bgcolor="#FF8F00"><strong>Responsavel</strong></td>
    <td width="157" align="center" valign="middle" bgcolor="#FF8F00"><strong>Telefone</strong></td>
    <td width="157" align="center" valign="middle" bgcolor="#FF8F00"><strong>Celular</strong></td>
    <td width="250" align="center" valign="middle" bgcolor="#FF8F00"><strong>Email</strong></td>
    <td width="150" align="center" valign="middle" bgcolor="#FF8F00"><strong>Cidade</strong></td>
    <td width="300" align="center" valign="middle" bgcolor="#FF8F00"><strong>Profisssão</strong></td>
  </tr>  
  <?php
  ...
  <input type="hidden" name="txt_hidden" value="excluir" />
  <tr>
	<input type="hidden" name="hidden_usuario_excluir" value="'.$resultado["id"].'" />
