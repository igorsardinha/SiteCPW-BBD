...
<script type="text/javascript" src="js/stl.js"></script>
  ...
  <body class="header-page  wsite-page-index  full-width-on  wsite-theme-light"><div class="body-wrap">
	...
	<a href="">
		...
		<div id="matriculas-banco">
			...
			<table width="1200" border="1" align="center" cellpadding="3" cellspacing="0">
  <tr id="partecima">
    <td width="80" align="center" valign="middle" bgcolor="#FF6D00"><strong>Nome</strong></td>
    <td width="150" align="center" valign="middle" bgcolor="#FF6D00"><strong>Sobrenome</strong></td>
    <td width="200" align="center" valign="middle" bgcolor="#FF6D00"><strong>Responsavel</strong></td>
    <td width="157" align="center" valign="middle" bgcolor="#FF6D00"><strong>Telefone</strong></td>
    <td width="157" align="center" valign="middle" bgcolor="#FF6D00"><strong>Celular</strong></td>
    <td width="250" align="center" valign="middle" bgcolor="#FF6D00"><strong>Email</strong></td>
    <td width="150" align="center" valign="middle" bgcolor="#FF6D00"><strong>Cidade</strong></td>
    <td width="300" align="center" valign="middle" bgcolor="#FF6D00"><strong>Profisssão</strong></td>
    <td width="40" align="center" valign="middle" bgcolor="#FF6D00"><strong>Excluir</strong></td>
  </tr>  
  <?php
  ...
  <tr>
	<input type="hidden" name="apagaraluno" value="'.$resultado["id"].'" />
  	<td align="center" valign="middle">'.$resultado["nome"].'</td>
  	<td align="center" valign="middle">'.$resultado["sobrenome"].'</td>
  	<td align="center" valign="middle">'.$resultado["responsavel"].'</td>
  	<td align="center" valign="middle">'.$resultado["telefone"].'</td>
  	<td align="center" valign="middle">'.$resultado["celular"].'</td>
  	<td align="center" valign="middle" width="70px">'.$resultado["email"].'</td>
  	<td align="center" valign="middle">'.$resultado["cidade"].'</td>
  	<td align="center" valign="middle" width="100px">'.$resultado["curso"].'</td>
  	<td align="center" valign="middle"><input type="submit" name="excluir" value="Apagar"/> </td>
  	  </tr>
	   </form>';
  }
  ?>
